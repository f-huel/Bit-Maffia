...
<nav class="stroke navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse show float-right" id="navbarNav">
                <ul class="d-inline navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a href="event.php">EVENT</a></li>
                    <li class="nav-item"><a href="ideas.php">IDEAS</a></li>
                    <li class="nav-item"><a href="contact.php">CONTACT</a></li>
                    <li class="nav-item"><a href="team.php">TEAM</a></li>
                </ul>
            </div>
